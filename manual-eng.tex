...
\author{
  ...
  Ivan A. Denisov \\ % Иван Андреевич Денисов \\
  Nikita A. Filatov \\ % Никита Алексеевич Филатов \\
  Anton S. Bukatin \\ % Антон Сергеевич Букатин \\
  Kirill A. Lukyanenko\\  % Лукьяненко Кирилл Андреевич \\
  Vladimir V. Sorokin\\ % Сорокин Владимир Викторович \\
  Anton S. Yakimov\\  % Якимов Антон Сергеевич \\  
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \section{Instrument assembly}
   ...
   \newpage    
    ...
    \begin{figure}[H]
	  \begin{center}
	  \includegraphics[width=\textwidth]{imgs/1_Controller.pdf}
    ...
    \begin{figure}[H]
	  \begin{center}
	  \includegraphics[width=\textwidth]{imgs/2_PowerAndControl.pdf}
    ...
    \begin{figure}[H]
	  \begin{center}
	  \includegraphics[width=\textwidth]{imgs/3_RelaysAndSensors.pdf}
    ...
    \begin{figure}[H]
	  \begin{center}
	  \includegraphics[width=\textwidth]{imgs/device-structure3.pdf}
...
The figure \ref{fig:bodymetal} shows a 3D sketch of the result of metal processing.
    \begin{figure}[H]
	  \begin{center}
	  \includegraphics[width=\textwidth]{imgs/body-metal.pdf}
	  \caption{The maket of panel around OLED displays.}
	  \label{fig:bodymetal}
	  \end{center}
    \end{figure}
